...
#include "BTTask_SetSearching.h"

#include "GCFPS/AI/Enforcer/AIEnforcerController.h"
#include "BehaviorTree/BlackboardComponent.h"


EBTNodeResult::Type UBTTask_SetSearching::ExecuteTask( UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory )
{
	...
	if (AIEnforcerController)
	{
		...
		// USE ENUM
		BlackboardComp->SetValueAsBool( "IsSearching", true );
